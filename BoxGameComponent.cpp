...
void BoxGameComponent::Initialize()
{
	...
	bool compileResult = CompileD3DShader("2D_Shaders.txt", "VSMainMove", "vs_5_0", &VertexShaderByteCode);
	...
	compileResult = CompileD3DShader("2D_Shaders.txt", "PSMain", "ps_5_0", &PixelShaderByteCode);
